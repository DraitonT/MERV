...
function [DV_dep, DV_arr, transferTime] = interplantarySolver2(departurePlanet, targetPlanet, Isp_dep, Isp_arr, z_parking_per_dep, z_parking_apo_dep, z_parking_per_arr,z_parking_apo_arr)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   EDITABLE   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
