...
TOF_max = 1550;  %[days] Maximum TOF   (Recommended: Mercury=150, Venus=200, Mars=500, Jupiter=1500, Saturn=3500, Uranus=8000, Neptune=10000)
...
if strcmp(Planet_1,'Earth')
    if strcmp(Planet_2,'Jupiter') || strcmp(Planet_2,'Saturn')
        ...
        h1b.Color = 'k';
%         h2.LevelList = 300:25:1200;       
    end
elseif strcmp(Planet_1,'Jupiter') 
    if strcmp(Planet_2,'Neptune')
        h1a.LevelList = [0:5:100,100:10:150,150:25:400];
        h1b.Color = 'none';
%         h2.LevelList = 3000:250:10000;
    elseif strcmp(Planet_2,'Pluto')
        h1a.LevelList = [0:5:100,100:10:150,150:25:400];
