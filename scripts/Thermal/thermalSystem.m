...
% Calculate the radiative heat transfer using Stefan-Boltzmann law
heat_transfer_W = emissivity * stefan_boltzmann_constant * surface_area_m2 * ...
                  (temp_hot_K^4 - temp_cold_K^4);

heat_transfer_W = heat_transfer_W - passive_system_W * num_heat_pipes;
% Display the result
